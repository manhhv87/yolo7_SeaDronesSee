...
if __name__ == '__main__':
    ...
    def get_args():
        ...
        parser.add_argument('--altitude', nargs='+', default=None,
                            help='Altitude to run the evaluation script with [0,50],[50,100],[100,150]')
    ...
    od.evaluate_coco(file_name=preds_output_pth, categories=[
                     1, 2, 3, 4, 5], ground_truth=truth_output_pth)

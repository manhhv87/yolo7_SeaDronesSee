...
if __name__ == '__main__':
    def get_args():
        ...
        parser.add_argument('--original', default=None, type=str,
                            help='Path to the original annotations file.')
        parser.add_argument('--fixed', default=None, type=str,
                            help="Path to the fixed annotations file.")
    ...
    for i in range(len(data1['images'])):
        ...
        # list of ditcs
        img_annots1 = [
            annots for annots in annotations1 if annots['image_id'] == img_id]
        # list of ditcs
        img_annots2 = [
            annots for annots in annotations2 if annots['image_id'] == img_id]

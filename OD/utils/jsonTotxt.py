...
categories = {"0": "ignored", "1": "swimmer", "2": "boat",
...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotation', type=str, default=None,
                        help='Path to the annotaion json file')
    ...
    for img in file['images']:
        ...
        img_id = id
        img_annots = [annots for annots in file['annotations']
                      if annots['image_id'] == img_id]  # list of dics

...
colors = {0: (0, 100, 100), 1: (0, 255, 0), 2: (255, 255, 51), 3: (
    0, 255, 255), 4: (255, 0, 0), 5: (255, 102, 255), 6: (51, 153, 255)}
...
if __name__ == '__main__':
    ...
    if opt.range is not None:
        ...
        if low and imgs:
            raise (
                "Can not run script with images and range, please choose only one at a time")

...
if __name__ == '__main__':
    ...
    if options.i <= 0:
        raise ValueError(
            "Please enter a valid number that is at least 1 or bigger")
    ...
    if options.output == None:
        raise ValueError(
            "Please enter a valid path for the output directory, where the images will be saved")
            ...
            for annot in annotations:
                if annot["image_id"] == id:
                    ...
                    cv2.rectangle(img, (topLeftX, topLeftY), (topLeftX + width,
                                  topLeftY + height), colors[annot['category_id']], 3)
